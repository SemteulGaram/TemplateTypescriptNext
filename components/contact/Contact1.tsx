...
class Contact1 extends React.Component<Props, State> {
        ...
        <div className='contact1__group_form' css={css`{
          ...
          <form css={css`{
            ...
            <div className='contact1__group1' css={css`{
              ...
              <input className='inputs inputs--single' type='text' placeholder='자녀 이름' />
              <input className='inputs inputs--single' type='text' placeholder='자녀 학교' />
              <input className='inputs inputs--single' type='text' placeholder='자녀 학년' />
            </div>
            <div className='contact1__group2' css={css`{
              ...
              <input className='inputs inputs--single' type='text' placeholder='학부모 연락처' />
